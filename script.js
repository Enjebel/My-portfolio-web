...
document.addEventListener("DOMContentLoaded", () => {
  ...
  chatbotBody.innerHTML = `
    <div class="chat-log">
      ...
      <p>Ask me:</p>
      <ul>
        <li>What type of projects have you worked on?</li>
        ...
        <li>How do you approach problem-solving in your work?</li>
        <li>What motivates you to learn new technologies?</li>
      </ul>
    </div>
  ...
  const getBotResponse = (message) => {
    ...
    if (msg.includes('data') || msg.includes('web') || msg.includes('dashboard')) {
      return "I've worked on various projects including web development, and software solutions.";
    }
    ...
    if (msg.includes('services') || msg.includes('offer') || msg.includes('provide')) {
      return "My services include, Web Development, Digital Marketing Strategy, Branding and graphics.";
    }
